...
getwd()
setwd("C:/Users/JasonLee/Documents/McDaniel/ANA_505")
...
heights <- df$women.height
weights <- df$women.weight
...
df_new <- data.frame(heights, weights)
...
subset_df <- subset(df, women.height>65)
